        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 text-gray-900 relative overflow-hidden">
            ...
            <header className="absolute top-0 left-0 right-0 z-20 container mx-auto px-6 py-4">
                <div className="flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center space-x-6">
                        <button
                            className="px-4 py-2 bg-white/80 backdrop-blur-sm border border-purple-200 rounded-lg text-purple-600 hover:bg-purple-50 transition-all cursor-pointer hover:scale-105"
                            onClick={() => navigate('/')}
                        >
                            Back to Home
                        </button>
            ...
            <div
                ref={cardRef}
                className="bg-white/95 backdrop-blur-xl border border-purple-200 rounded-2xl p-8 shadow-2xl w-96 relative z-10 transition-transform duration-200"
                style={{
                    transformStyle: 'preserve-3d',
            ...
            >
                {/* Shimmer effect top bar */}
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-purple-500 via-purple-600 to-purple-500 rounded-t-2xl overflow-hidden">
                    <div
                        className="h-full w-20 bg-gradient-to-r from-transparent via-white to-transparent opacity-50"
                        style={{
                ...
                {isSuccess ? (
                    <div className="flex flex-col items-center justify-center py-12">
                        <div className="w-20 h-20 rounded-full bg-green-100 flex items-center justify-center mb-6 border border-green-300">
                            <svg width="40" height="40" viewBox="0 0 50 50" fill="none">
                                <path
                                    d="M14 27L21 34L36 16"
                                    stroke="#22c55e"
                    ...
                    <>
                        ...
                        <div className="text-center mb-2">
                            <div className="flex items-center justify-center mb-2">
                                ...
                                <span className="ml-2 text-sm text-purple-600 font-medium">AI-Powered Registration</span>
                            </div>
                        </div>
                        ...
                        <div className="mb-8">
                            <div className="flex justify-between items-center mb-4">
                                {[1, 2, 3].map((step) => (
                                    <div key={step} className="flex flex-col items-center">
                                        <div
                                            className={`w-10 h-10 rounded-full flex items-center justify-center mb-2 border-2 transition-all duration-300 ${formStep >= step - 1
                                                    ? 'bg-gradient-to-r from-purple-500 to-purple-600 border-purple-400 text-white'
                                                    : 'bg-gray-100 border-gray-300 text-gray-500'
                                                }`}
                                            style={{
                                                transform: formStep >= step - 1 ? 'scale(1.1)' : 'scale(1)'
                                            }}
                                        >
                        ...
                        <div className="relative">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleChange}
                                            placeholder="Enter your full name"
                                            className="w-full p-4 bg-gray-50 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition-all"
                                        />
                                    </div>
                                    <button
                                        onClick={nextStep}
                                        className="w-full py-4 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-xl font-semibold hover:from-purple-600 hover:to-purple-700 transition-all shadow-lg cursor-pointer hover:scale-105 hover:shadow-purple-300/50"
                                    >
                                        Continue →
                                    </button>
                                </div>
                            ...
                            {formStep === 1 && (
                                <div className="space-y-6">
                                    ...
                                    <div className="flex space-x-4">
                                        <button
                                            onClick={prevStep}
                                            className="w-1/3 py-4 bg-white border border-gray-300 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 transition-all cursor-pointer hover:scale-105"
                                        >
                                            ← Back
                                        </button>
                                        <button
                                            onClick={nextStep}
                                            className="w-2/3 py-4 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-xl font-semibold hover:from-purple-600 hover:to-purple-700 transition-all shadow-lg cursor-pointer hover:scale-105 hover:shadow-purple-300/50"
                                        >
                                            Continue →
                                        </button>
                                    </div>
                            ...
                            {formStep === 2 && (
                                <div>
                                    <div className="mb-6">
                                        <h3 className="text-lg font-semibold mb-4 text-gray-900">Review Your Information</h3>
                                    ...
                                    <div className="space-y-6">
                                        <div className="flex space-x-4">
                                            ...
                                            <button
                                                onClick={handleSubmit}
                                                className="w-2/3 py-4 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-xl font-semibold hover:from-purple-600 hover:to-purple-700 transition-all shadow-lg flex items-center justify-center cursor-pointer hover:scale-105 hover:shadow-purple-300/50"
                                                disabled={isLoading}
                                            >
                                                {isLoading ? (
                                                    <>
                        ...
                        <div className="text-center mt-8 pt-6 border-t border-gray-200">
                            <p className="text-sm text-gray-600">
                                Already have an account?{' '}
                                <a href="/login" className="text-purple-600 hover:text-purple-700 transition-colors font-medium">
                                    Sign In →
                                </a>
                            </p>
                        </div>
            ...
            {/* Background decorative elements */}
            <div className="absolute top-1/4 left-10 w-64 h-64 bg-purple-200/20 rounded-full blur-3xl"></div>
            <div className="absolute bottom-1/4 right-10 w-80 h-80 bg-purple-100/30 rounded-full blur-3xl"></div>
